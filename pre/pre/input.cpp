...
//static long	Right_x=0;
//static long	Right_y=0;
LONG					width;
LONG					heigth;
LONG					tmp;
//=============================================================================
...
float GetStickPosWidth(void)
{
	...
	if (padCount == NULL)
	{
		...
		return ((float)(width / 65535.0f) -0.5f);
	
}

float GetStickPosHeigth(void)
{
	if (padCount == NULL)
	{
		return false;
	...
	return ((float)(heigth / 65535.0f) -0.5f);
